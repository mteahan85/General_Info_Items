...
public class items {
	...
	/*	itemsArray[39] = new items("Elixir of Brilliance",
		...
		itemsArray[96] = new items("Moonflair Spellblade",
		...
		itemsArray[100] = new items("Needlessly Large Rod",
		itemsArray[101] = new items("Negatron Cloak",
		...
		itemsArray[103] = new items("Nomad's Medallion",
		itemsArray[104] = new items("Null-Magic Mantle",
		itemsArray[105] = new items("Odyn's Veil",
		...
		itemsArray[107] = new items("Oracle's Extract",
		itemsArray[108] = new items("Oracle's Lens",
		itemsArray[109] = new items("Orb of Winter",
		itemsArray[110] = new items("Overlord's Bloodmail",
		itemsArray[111] = new items("Phage",
		...
		itemsArray[113] = new items("Pickaxe",
		itemsArray[114] = new items("Poro-Snax",
		itemsArray[115] = new items("Prospector's Blade",
		itemsArray[116] = new items("Prospector's Ring",
		itemsArray[117] = new items("Quicksilver Sash",
		...
		itemsArray[121] = new items("Recurve Bow",
		itemsArray[122] = new items("Rejuvenation Bead",
		itemsArray[123] = new items("Relic Shield",
		...
		itemsArray[125] = new items("Ruby Crystal",
		...
		itemsArray[129] = new items("Sanguine Blade",
		itemsArray[130] = new items("Sapphire Crystal",
		itemsArray[131] = new items("Scrying Orb",
		itemsArray[132] = new items("Seeker's Armguard",
		...
		itemsArray[134] = new items("Sheen",
		itemsArray[135] = new items("Sightstone",
		...
		itemsArray[137] = new items("Spectre's Cowl",
		itemsArray[138] = new items("Spellthief's Edge",
		...
		itemsArray[142] = new items("Spirit Stone",
		...
		itemsArray[145] = new items("Stealth Ward",
		itemsArray[146] = new items("Stinger",
		...
		itemsArray[148] = new items("Sweeping Lens",
		...
		itemsArray[152] = new items("Targon's Brace",
		itemsArray[153] = new items("Tear of the Goddess",
		...
		itemsArray[156] = new items("The Brutalizer",
		itemsArray[157] = new items("The Hex Core",
		itemsArray[158] = new items("The Lightbringer",
		...
		itemsArray[160] = new items("Tiamat",
		itemsArray[161] = new items("Total Biscuit of Rejuvenation",
		...
		itemsArray[164] = new items("Vampiric Scepter",
		itemsArray[165] = new items("Vision Ward",
		...
		itemsArray[167] = new items("Warden's Mail",
		itemsArray[168] = new items("Warding Totem",
		...
		itemsArray[170] = new items("Wicked Hatchet",
		...
		itemsArray[173] = new items("Wooglet's Witchcap",
		itemsArray[174] = new items("Wriggle's Lantern",
